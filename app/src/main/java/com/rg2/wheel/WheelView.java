...
import com.rg2.wheel.adapters.WheelViewAdapter;
...
//			0xcfE9E9E9, 0x3fE9E9E9 };
	...
	private void drawCenterRect(Canvas canvas) {
		...
		//paint.setColor(ContextCompat.getColor(context,R.color.grayA));
		paint.setColor(context.getResources().getColor(R.color.grayA));
		// 设置线宽
